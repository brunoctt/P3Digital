		...
		IF(lcd_busy = '0' AND lcd_enable = '0') THEN
			...
			END IF;					
				CASE char IS
					...
					when 8 => lcd_bus <= "1000110010";  --2 
					when 9 => lcd_bus <= "1000100000"; --ESPAÇO
					when 10 => if menu = "10" then
										lcd_bus <= "1001001110"; --N
								elsif menu = "11" then
										lcd_bus <= "1001010001"; --Q
								elsif menu = "01" then
										lcd_bus <= "1001000110"; --F
								end if;
